...
//         `${API_URL}/api/deposits?page=${page}&limit=10&search=${search}&status=approved`,
//         config
//       );
...
//     } catch (err) {
//       console.error("❌ Failed to fetch approved deposits:", err);
//     } finally {
//       setLoading(false);
//     }
//   };
...
//         <Wallet size={18} /> Approved Deposits
//       </h2>
...
//       ) : deposits.length === 0 ? (
//         <p className="text-gray-300">No approved deposits found.</p>
//       ) : (
...
//                 <th className="p-3 text-left border border-gray-700">Updated At</th>
...
//                   </td>
//                   <td className="p-3 border border-gray-700 text-green-300">
//                     {d.userId?.email}
//                   </td>
...
//                   </td>
//                   <td className="p-3 border border-gray-700">
//                     <button className="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 rounded text-white text-sm">
//                       View
//                     </button>
//                   </td>
//                 </tr>
